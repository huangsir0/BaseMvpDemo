...
public class BallsLoadingView extends View {
    ...
    public BallsLoadingView(Context context) {
        super(context);
        Log.i(AppConstant.Log.Log_TAG,"BallsLoadingView1");
        parseAttrs(null);
    }

    public BallsLoadingView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        Log.i(AppConstant.Log.Log_TAG,"BallsLoadingView2");
        parseAttrs(attrs);
        init();
    }

    public BallsLoadingView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        Log.i(AppConstant.Log.Log_TAG,"BallsLoadingView3");
        parseAttrs(attrs);
        init();
    }
    ...
    public BallsLoadingView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        Log.i(AppConstant.Log.Log_TAG,"BallsLoadingView4");
        parseAttrs(attrs);
        init();
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        Log.i(AppConstant.Log.Log_TAG,"onMeasure");
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        Log.i(AppConstant.Log.Log_TAG,"onDraw");
        for (int i =0;i<POINTS_COUNT;i++){
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        Log.i(AppConstant.Log.Log_TAG,"onSizeChanged");
        setupBalls(w,h);
    }
